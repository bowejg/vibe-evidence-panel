...
export function StudySetup() {
  ...
  // Switch back to files view if in participants view and no processed files
  useEffect(() => {
    if (viewMode === 'participants' && processedFiles.length === 0) {
      setViewMode('files')
    }
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div className="inline-flex items-center bg-neutral-50 rounded-md border border-neutral-200 p-0.5">
                    ...
                    <button
                      onClick={() =>
                        processedFiles.length > 0 && setViewMode('participants')
                      }
                  ...
                  <table className="w-full table-fixed">
                    <thead>
                      <tr className="border-b border-neutral-100">
                        ...
                        <th className="w-[15%] pb-3 text-left text-xs font-medium text-neutral-500 uppercase tracking-wide">
                          Speakers
                        </th>
                        <th className="w-[20%] pb-3 text-left text-xs font-medium text-neutral-500 uppercase tracking-wide">
                          File Name
                      ...
                      {uploadedInterviews
                        ...
                        .map((interview) => (
                          ...
                          >
                                ...
                                {fileParticipants[interview.id]
                                  ...
                                  .map((speaker, idx) => {
                                    return (
                                      <span
                                        key={idx}
                                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium bg-teal-50 text-teal-700"
                                      >
                            ...
                            <td className="w-[20%] py-4 pr-6 text-sm text-neutral-700">
                              {interview.fileName}
                            </td>
                            <td className="w-[12%] py-4 pr-6 text-sm text-neutral-700">
                              en-US
                            </td>
                            <td className="w-[45%] py-4 pr-6">
                              <div className="flex flex-wrap gap-2">
