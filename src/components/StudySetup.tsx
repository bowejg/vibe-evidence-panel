          ...
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200/60 overflow-hidden hover:shadow-md transition-shadow duration-200">
            <div className="p-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <button
                  onClick={() => console.log('Discussion Guide clicked')}
                  className="w-full flex items-start space-x-3 p-3.5 rounded-lg bg-neutral-50/50 hover:bg-neutral-100/50 text-left transition-all duration-150 border border-transparent hover:border-neutral-200/60"
                >
